            ...
            <div class="container _custom_container">
                ...
                <div class="collapse navbar-collapse" id="navbarSupportedContent">
                    ...
                    <ul class="navbar-nav mb-2 mb-lg-0 _header_nav_list ms-auto _mar_r8">
                        ...
                        <li class="nav-item _header_nav_item">
                            <a class="nav-link _header_nav_link" aria-current="page" >
                                ...
                                <span class="_counting">
                                </span> */}
                                <button
                                    onClick={logoutClickHandler}
                                    style={{ borderRadius: "10px", border: 'none', background: "#377DFF", color: "white", height: "2rem", width: "5rem" }}
                                    type="button"
                                >Log out</button>
                            </a>
                    ...
                    <div class="_header_nav_profile">
                        ...
                        <div class="_header_nav_dropdown">
                            <p class="_header_nav_para">{loggedinUser.firstname}&nbsp;{loggedinUser.lastname}</p>
