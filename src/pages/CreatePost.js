...
function CreatePost() {
    ...
    // Trigger file input when user clicks Photo button
    ...
    const postHandler = async () => {
        ...
        try {
            // console.log(token, "++++++", description, "++++++++++", isPrivate, "+++", image)
            // console.log(formData);
            const res = await axios.post(
                `${process.env.REACT_APP_BACKEND_URL}/createPost`,
                { token, description, isPrivate },
    ...
    // const postHandler = () => {
    //     const token = localStorage.getItem("token");
    //     // console.log(`${description}---------${isPrivate}-------${token}`);
    //     axios.post(`${process.env.REACT_APP_BACKEND_URL}/createPost`, { token, description, isPrivate })
    //         .then((res) => {
    //             console.log(res.data.message);
    //         })
    //         .catch((err) => {
        ...
        <div class="_feed_inner_text_area  _b_radious6 _padd_b24 _padd_t24 _padd_r24 _padd_l24 _mar_b16">
            <div class="_feed_inner_text_area_box">
                ...
                <div class="form-floating _feed_inner_text_area_box_form ">
                    <textarea class="form-control _textarea"
            ...
            <div class="_feed_inner_text_area_bottom">
                <div class="_feed_inner_text_area_item">
                    <div class="_feed_inner_text_area_bottom_photo _feed_common">
                        ...
                        > <span class="_feed_inner_text_area_bottom_photo_iamge _mar_img"> <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" fill="none" viewBox="0 0 20 20">
